                    ...
                    <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
                        ...
                        <div class="grid grid-cols-3 gap-4 p-4">
                            <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Ventas</div>
                            </a>
                            <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Usuarios</div>
                            </a>
                            <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <Link :href="route('profile.show')" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <Link :href="route('item.index')" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Productos</div>
                            </Link>
                            <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Precios</div>
                            </a>
                            <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Facturacion</div>
                            </a>
                            <a href="#" @click="logout"
                               class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Cerrar Session</div>
                            </a>
                        </div>
                    </div>
                    <ThemeSwitcher />
                    ...
                    <div class="flex items-center ml-3">
                        <div>
                            <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                                <span class="sr-only">Abrir menu del Usuario</span>
