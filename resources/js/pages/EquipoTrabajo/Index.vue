...
import { EquipoTrabajo, getDefaultAttributes, selectedAttributes } from '@/Data/EquipoTrabajo';
...
const props = defineProps({
    listado: {
        type: Array as () => Array<EquipoTrabajo>,
        default: () => [],
    },
    crear: {
        type: Boolean,
...
<template>
    <Head :title="UtilsServices.capitalizeFirstLetter(model.toUpperCase())" />
