...
import { Contrato, getDefaultAttributes, selectedAttributes } from '@/Data/Contrato';
                        ...
                        <TableLayout :mostrarfoot="datas.list.length > 10">
                            <template #thead>
                                <tr class="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 dark:from-indigo-900/30 dark:to-purple-900/30">
                                    ...
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Cliente ID</th>
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Servicio ID</th>
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Descripción</th>
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Costo Total</th>
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Estado</th>
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Fecha Inicio</th>
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Fecha Fin</th>
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Estado Pago</th>
                            ...
                            <template #tbody>
                                ...
                                >
                                    ...
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Cliente ID">
                                        {{ item.cliente_id }}
                                    </td>
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Servicio ID">
                                        {{ item.servicio_id }}
                                    </td>
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Descripción">
                                        {{ item.descripcion }}
                                    </td>
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Costo Total">
                                        {{ item.costo_total }}
                                    </td>
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Estado">
                                        {{ item.estado }}
                                    </td>
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Fecha Inicio">
                                        {{ item.fecha_inicio }}
                                    </td>
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Fecha Fin">
                                        {{ item.fecha_fin }}
                                    </td>
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Estado Pago">
                                        {{ item.estado_pago }}
                                    </td>
