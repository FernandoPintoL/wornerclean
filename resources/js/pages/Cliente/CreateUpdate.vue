                        ...
                        <div class="form-group animate-fadeIn" style="animation-delay: 0.4s;">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    required
                                />
                                <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none" v-if="datas.direccionError">
                                    <svg class="h-5 w-5 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                            </div>
                            <InputError class="mt-2" :message="datas.direccionError" />
                        </div>

                        <!-- Tipo de Cliente - Full width on all screens -->
                        <div class="form-group col-span-1 md:col-span-2 animate-fadeIn" style="animation-delay: 0.5s;">
                            <label
                                for="tipo_cliente"
                                :class="[
                                    'mb-2 block text-sm font-medium transition-colors duration-200',
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute inset-y-0 right-8 flex items-center pr-3 pointer-events-none" v-if="datas.tipo_cliente_idError">
                                    <svg class="h-5 w-5 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                            </div>
                            <InputError class="mt-2" :message="datas.tipo_cliente_idError" />
                        </div>
                    </div>

                    <!-- Submit button with improved styling -->
                    <div class="mt-8 flex justify-center sm:justify-end animate-fadeIn" style="animation-delay: 0.6s;">
                        <button
                            type="submit"
                            @click="submit_create"
                            :class="[
