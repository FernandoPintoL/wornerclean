...
import { Usuario, getDefaultAttributes, selectedAttributes } from '@/Data/User';
        ...
        <div class="p-4 sm:p-6 lg:p-8 transition-all duration-300">
            <div class="w-full max-w-7xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-6 transition-all duration-300 animate-fadeIn">
                    <HeaderIndex :title="'Usuario'" class="mb-4" />
                        ...
                        <TableLayout :mostrarfoot="datas.list.length > 10">
                            <template #thead>
                                <tr class="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 dark:from-indigo-900/30 dark:to-purple-900/30">
                                    ...
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Email</th>
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Username</th>
                            ...
                            <template #tbody>
                                ...
                                >
                                    ...
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Email">
                                        {{ item.email }}
                                    </td>
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Username">
                                        {{ item.usernick }}
                                    </td>
                                    <td class="p-0 border-0" data-label="Acciones">
                                        <TdTable
                                            :creado="UtilsServices.fecha(item.createdAt)"
                                            :actualizado="UtilsServices.fecha(item.updatedAt)"
                                            :model_path="model"
                                            :itemId="item.id ?? ''"
