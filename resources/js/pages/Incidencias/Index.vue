...
import { Incidencia, getDefaultAttributes, selectedAttributes } from '@/Data/Incidencia';
import { ParamsConsulta } from '@/Data/PaginacionLaravel';
import AppLayout from '@/layouts/AppLayout.vue';
import { IncidenciaNegocio } from '@/Negocio/IncidenciaNegocio';
...
const negocio = new IncidenciaNegocio();
...
const props = defineProps({
    listado: {
        type: Array as () => Array<Incidencia>,
        default: () => [],
    },
    crear: {
        type: Boolean,
