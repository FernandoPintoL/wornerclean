...
import { Role, getDefaultAttributes, selectedAttributes } from '@/Data/Role';
                        ...
                        <TableLayout :mostrarfoot="datas.list.length > 10">
                            <template #thead>
                                <tr class="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 dark:from-indigo-900/30 dark:to-purple-900/30">
                                    ...
                                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider dark:text-gray-300">Guard</th>
                            ...
                            <template #tbody>
                                ...
                                >
                                    ...
                                    <td class="p-4 text-sm md:text-base font-medium text-gray-900 dark:text-white" data-label="Guard">
                                        {{ item.guard_name }}
                                    </td>
